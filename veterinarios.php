...
<div class="panel panel-primary">
   <div class="panel-heading">
    <h3 class="panel-title">Veterinarios</h3>
  </div>
  <div class="panel-body">
<ul class="nav nav-tabs">
  <li class="active"><a href="veterinarios.php">Registro</a></li>
  <li><a href="table_veterinarios.php">Listado</a></li>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic">Tipo Documento</label>
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">No Documento</label>  
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="selectbasic" name="selectbasic" class="form-control">
      <option value="1">Maasculino</option>
